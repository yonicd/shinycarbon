...
golem::fill_desc(
  pkg_name = "shinycarbon", # The Name of the package containing the App 
  pkg_title = "shinycarbon", # The Title of the package containing the App 
  pkg_description = "Shinyapp for tweeting carbonate outputs.", # The Description of the package containing the App 
  author_first_name = "Jonathan", # Your First Name
  author_last_name = "Sidi",  # Your Last Name
  author_email = "yonicd@gmail.com",      # Your Email
